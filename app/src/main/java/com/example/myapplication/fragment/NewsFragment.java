...
public class NewsFragment extends Fragment {
    ...
    public void initView() {
        ...
        webView.setWebChromeClient(new BrowserChromeClient(webView));   //setWebChromeClient辅助WebView处理JavaScript的对话框，网站图标，网站title，加载进度等
        webView.setWebViewClient(new BrowserViewClient());      //setWebClient帮助WebView处理各种通知、请求事件
